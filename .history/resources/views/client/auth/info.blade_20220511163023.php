                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body">
                                        <div class="shipinfo">
                                            ...
                                            <p><a href="{{ route('view.change.info') }}" class="fv-btn">Đổi thông tin cá nhân</a></p>
                                            @if ($storeInfo != null)
                                                ...
                                                @endif
                                            @else
                                            <a href="#" class="ship-to-another-trigger fv-btn"><i class="zmdi zmdi-long-arrow-right "></i>Đăng ký gian hàng</a>
                                            @endif
