                                        ...
                                        <div class="shipinfo">
                                            ...
                                            @if ($storeInfo != null)
                                                @if ($storeInfo->ch_trangthai == 0)
                                                    <p class="hetthoigian" style="color: white; a-align: center;">Sàn đấu giá chưa được xác thực <i class="fa fa-window-close-o" aria-hidden="true" style="font-size:20px"></i></p> 
                                                @else
