...
<div class="body__overlay"></div>
                                            ...
                                            <div class="shp__cart__wrap">
                                                ...
                                                <div class="shp__single__product">
                                                    ...
                                                    <div class="shp__pro__details">
                                                        ...
                                                        <a href="{{ route('payment.index', ['idCart'=>$item->gh_id]) }}" title="Thanh toán" class="fv-btn"
                                                        style="background: #c43b68 none repeat scroll 0 0;
    ...
    transition: all 0.4s ease 0s;"
                                                        >Thanh toán</i></a>
                                                        {{-- <button class="cr__btn">haha</button> --}}
                                                    </div>
                                                </div>
                                                @endforeach
