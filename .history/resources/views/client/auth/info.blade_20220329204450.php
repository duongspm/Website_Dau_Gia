...
@section('content')
<link rel="stylesheet" href={{asset("deskapp/vendors/styles/dangkygianhang.css")}}>
                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body">
                                        <div class="shipinfo">
                                            ...
                                            <div class="wrapper-dangkygianhang">
                                                <div class="single-price-dangkygianhang">
                                                    <h1>Đăng ký gian hàng</h1>
                                                    <div class="price-dangkygianhang">
                                                        <h2>Free</h2>
                                                    </div>
                                                    <div class="deals-dangkygianhang">
                                                        <h4>Tạo sàn đấu giá</h4>
