                                        ...
                                        <div class="shipinfo">
                                            ...
                                            @if ($storeInfo != null)
                                                @if ($storeInfo->ch_trangthai == 0)
                                                    <p class="hetthoigian" style="color: white;">Gian hàng chưa được xác thực</p> <i class="fa fa-window-close-o" aria-hidden="true"></i>
                                                @else
                                                    <a href="{{ route('store.detail') }}" style="font-size: 24px"><i class="zmdi zmdi-long-arrow-right" ></i>Xem gian hàng  <i class="fa fa-address-card-o"></i></a>
                                                @endif
                                            @else
