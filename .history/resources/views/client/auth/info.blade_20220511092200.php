...
<div class="body__overlay"></div>
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url({{ asset('client/banner/big-img/info.png') }}) no-repeat scroll center center / cover ;">
                                    ...
                                    <div class="accordion__body">
                                        ...
                                        <div class="shp__single__product">
                                            ...
                                            <div class="shp__pro__details">
                                                ...
                                                <span class="shp__price">{{ $item->ctdh_dongia }}</span>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
