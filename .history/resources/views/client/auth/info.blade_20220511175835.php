                                        ...
                                        <div class="shipinfo">
                                            ...
                                            @if ($storeInfo != null)
                                                @if ($storeInfo->ch_trangthai == 0)
                                                    <p class="hetthoigian" style="color: white; text-align: center;">Sàn đấu giá chưa được xác thực <i class="fa fa-window-close-o icons" aria-hidden="true" style="font-size:20px"></i></p> 
                                                @else
                                                    <a href="{{ route('store.detail') }}" style="font-size: 24px"><i class="zmdi zmdi-long-arrow-right" ></i><i class="fa fa-address-card-o"></i>Xem sàn đấu giá  <i class="fa fa-address-card-o"></i></a>
                                                @endif
                                            @else
