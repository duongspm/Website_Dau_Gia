...
<!-- Start Slider Area -->
<!-- Start Category Area -->
<section class="htc__category__area ptb--100" style="background-image:url(https://res.cloudinary.com/loly-cup-tea/image/upload/v1652069252/Thi%E1%BA%BFt_k%E1%BA%BF_ch%C6%B0a_c%C3%B3_t%C3%AAn_3_eylkrr.png); background-size: cover;">
    <div class="container" >
{{-- {{asset('client/images/logo/logo-auction.png')}}style="box-shadow: 0 0 1em 0 rgba(51,51,51,0.25);
" --}}
        <div class="row">
            <div class="col-xs-12">
