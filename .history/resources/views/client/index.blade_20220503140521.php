...
<section class="company">
    ...
    <div class="company-logos">
        <div class="company-logo">
            <img src="./images/google.svg" alt="google nek">
        </div>
        <div class="company-logo">
            <img src="./images/netflix.svg" alt="google nek">
        </div>
        <div class="company-logo">
            <img src="./images/airbnb.svg" alt="google nek">
        </div>
        <div class="company-logo">
            <img src="./images/amazon.svg" alt="google nek">
        </div>
        <div class="company-logo">
            <img src="./images/facebook.svg" alt="google nek">
        </div>
        <div class="company-logo">
            <img src="./images/grab.svg" alt="google nek">
        </div>
    </div>
</section>
@endsection
