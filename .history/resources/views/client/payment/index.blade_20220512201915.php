...
<!-- Start Bradcaump area -->
 <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0)  url({{ asset('client/images/banner/big-img/banner-bill.png') }}) no-repeat scroll center center / cover ;">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="bradcaump__inner">
                        ...
                        <h2 class="h1custom">THANH TOAN</h2>
