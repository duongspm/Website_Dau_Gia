                        ...
                        @endphp
                            @if (property_exists($detail,'dg_thoigianketthuc') == true)
                                ...
                                @if ($detail->dg_thoigianketthuc > Carbon\Carbon::now())
                                    ...
                                    <div class="sin__desc">
                                        <p class="hetthoigian" style="color:white">Chủ cửa hàng kinh doanh sản phẩm này không được phép tham gia đấu giá. </p>
                                    </div>
                                    ...
                                    @else
                                        <div class="sin__desc">
                                            <p class="hetthoigian" style="color:white">Vui lòng đăng nhập để tham gia đấu giá. <a href="{{ route('login.view') }}" class="fv-btn" style="padding: 11px 30px;">Tại đây →</a></p>
                                        </div>
                                    @endif
                                    </div>
