                ...
                <div class="shop">
                    <div class="shop-page">
                        ...
                        <div class="shop-page_info-list">
                            ...
                            <div class="shop-page_info-list-item">
                                <i class="fa fa-user-o" aria-hidden="true">&nbsp; &nbsp;&nbsp;Tên nhà thầu: <span class="shop-page_title">{{ $storeInfo->ch_ngaytao }}Duongg</span></i>
                            </div>
                            <div class="shop-page_info-list-item">
                                <i class="fa fa-whatsapp" aria-hidden="true">&nbsp; &nbsp;&nbsp;SĐT: <span class="shop-page_title">+096752611</span></i>
                            </div>
                            <div class="shop-page_info-list-item">
                                <i class="fa fa-envelope-o" aria-hidden="true">&nbsp; &nbsp;&nbsp;Gmail: <span class="shop-page_title"></span></i>
                            </div>
                            <div class="shop-page_info-list-item">
                                <i class="fa fa-calendar-o" aria-hidden="true">&nbsp; &nbsp;&nbsp;Tham Gia: <span class="shop-page_title">{{ $storeInfo->ch_ngaytao }}</span></i>
                            </div>
                        </div>
                    </div>
                </div>
