...
@section('content')
    ...
    <div class="ht__bradcaump__area"
        style="background: rgba(0, 0, 0, 0) url({{asset($storeInfo->ch_banner)}}{{asset($storeInfo->ch_banner)}}) no-repeat scroll center center / cover ;">
        ...
        <div class="shop-page">
            <div class="shop-page_info">
                <div class="shop-page_info-content">
                    <div class="shop-page_info-content-top">
                        ...
                        <h2 class="shop-page_infor-heading">{{ $storeInfo->ch_ten }}</h2>
                    </div>
                    
                    <div class="shop-page_info-content-bottom">
                        <div class="shop-page_info-bottom-follow">
                            <i class="fa fa-plus"> THEO DOI</i>
                        </div>
            ...
            <div class="shop-page_info-list">
                <div class="shop-page_info-list-item">
                    <i class="fa fa-shopping-basket" aria-hidden="true">&nbsp; &nbsp;&nbsp;San Pham: <span class="shop-page_title">1</span></i>
                </div>
                <i class="fa fa-store-alt"></i><i class="fal fa-store-alt"></i>
                <div class="shop-page_info-list-item">
                    <i class="fa fa-user-o" aria-hidden="true">&nbsp; &nbsp;&nbsp;Ten chu shop: <span class="shop-page_title">Duongg</span></i>
                </div>
                <div class="shop-page_info-list-item">
                    <i class="fa fa-whatsapp" aria-hidden="true">&nbsp; &nbsp;&nbsp;Sdt: <span class="shop-page_title">+096752611</span></i>
                </div>
                <div class="shop-page_info-list-item">
                    <i class="fa fa-envelope-o" aria-hidden="true">&nbsp; &nbsp;&nbsp;Gmail: <span class="shop-page_title">streetgang@gmail.com</span></i>
                </div>
                <div class="shop-page_info-list-item">
                    <i class="fa fa-calendar-o" aria-hidden="true">&nbsp; &nbsp;&nbsp;Tham Gia: <span class="shop-page_title">07/11/2021</span></i>
                </div>
            </div>
        </div>
    </div>
