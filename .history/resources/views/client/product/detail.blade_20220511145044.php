                ...
                <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                    <div class="ht__product__dtl">
                        ...
                        <ul  class="pro__prize">
                            ...
                            <li><a href="{{ route('client.product.by.store', ['id'=>$detail->ch_id]) }}" title="Xem sàn đấu giá">{{ $detail->ch_ten}} </a></li>
                        </ul>
                        <hr/>
                        @php
                        ...
                        @endphp
                            @if (property_exists($detail,'dg_thoigianketthuc') == true)
                                ...
                                <br>
                                <ul  class="pro__prize">
                                    <li class="old__prize">Gía tăng tối thiểu: </li>
                                    <li>{{ number_format($detail->dg_buocnhay) }} VNĐ</li>
                                </ul>
                                <br>
                                <ul  class="pro__prize">
                                    <li class="old__prize">Giá cao nhất: </li>
                                    <li class="h1custom btncustom" id="maxPrice">{{ $maxPrice != null ? number_format($maxPrice->ctdg_giatien) : 0 }} VNĐ</li>
                                </ul>
                                <br>
                                ...
                                @if ($detail->dg_thoigianketthuc > Carbon\Carbon::now())
                                        <form action="{{ route('client.product.audit') }}" method="GET">
                                            <div class="single-input">
                                                ...
                                                <button class="cr__btn">Đấu giá</button>
                                            </div>
