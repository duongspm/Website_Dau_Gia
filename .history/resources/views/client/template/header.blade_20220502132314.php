                    ...
                    <div class="col-md-7 col-lg-7 col-sm-7 col-xs-7">
                        <nav class="main__menu__nav hidden-xs hidden-sm">
                            <ul class="main__menu">
                                ...
                                <li class="drop"><img src={{asset("client/images/icons/logout_black_24dp.svg")}}<a href="#">Liên hệ & Góp ý</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                        <div class="header__right">
                            ...
                            <div class="htc__shopping__cart">
                                @if (Auth::guard('nguoidung')->check())
                                <p><a href="{{ route('logout') }}" style="color: red;"><img src={{asset("client/images/icons/logout_black_24dp.svg")}} style="height:23px; font-weight: 400;   "></a></p>
                                @endif
                            </div>
                        </div>
                    </div>
