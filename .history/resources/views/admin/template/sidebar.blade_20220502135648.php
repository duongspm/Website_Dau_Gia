<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Sidebar -->
    <div class="sidebar"><link rel="shortcut icon" type="image/x-icon" href={{asset("client/images/logo/logo-do-cocaybuado.png")}}>
        <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src={{asset("admin/img/user2-160x16.jpg")}} class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
