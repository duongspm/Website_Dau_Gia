        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                    <a href="{{ route('post.create') }}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Thêm mới</a>
                </div>
                        ...
                        <tr>
                          <td><img src="{{asset($item->bv_hinhanh)}}" alt="" class="img"></td>
                            ...
                            <td>
                              ...
                              <button class="btn btn-danger" type="submit"><i class="far fa-trash-alt"></i> Xoá</button>
                            </form>
                            </td>
                        </tr>
                        @endforeach
