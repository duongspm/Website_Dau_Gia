                  ...
                  <table id="category" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->dm_mota }}</td>
                            <td>
                                <a href="{{ route('category.edit', ['id'=>$item->dm_id]) }}" class="btn btn-warning"><i class="fas fa-pencil-alt"></i> Chỉnh sửa</a>
                                <a href="{{ route('category.delete', ['id'=>$item->dm_id]) }}" class="btn btn-danger"><i class="far fa-trash-alt"></i> Xoá</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
