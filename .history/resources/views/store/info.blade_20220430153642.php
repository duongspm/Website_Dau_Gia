              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Số sản phẩm</b> <a class="float-right">3</a>
                  </li>
                </ul>
                <a href="{{ route('order.update', $store->ch_id) }}"
                                          class="btn btn-warning" data-toggle="modal"
                                          data-target="#exampleModalCenter{{$store->ch_id}}" class="btn btn-primary btn-block"><b>Follow</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src="../../dist/img/photo1.png" alt="Banner">
                        </div>
                        <!-- /.col -->
