...
class Controller extends BaseController
{
    ...
    // }
    public function success($content) {
        $alert = ' <div class="card card-success card-outline">
        <div class="card-body">
        <button type="button" class="btn btn-success swalDefaultSuccess">&times;</button>
        <h5><i class="icon fas fa-check"></i> Thông báo!</h5>'.$content.'</div></div>';
        return $alert;
    }
